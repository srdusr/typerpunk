...
mod tests {
    ...
    fn test_stats_initialization() {
        ...
        assert_eq!(stats.error_positions, Vec::<usize>::new());
    ...
    fn test_stats_update() {
        ...
        // Comparing against a freshly-captured Instant::now() (as this
        // asserted before) can never pass - nanosecond-resolution clocks
        // don't produce two equal readings taken at different times. What's
        // actually being verified is that these got set at all.
